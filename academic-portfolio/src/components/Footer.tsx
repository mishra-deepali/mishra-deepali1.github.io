        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link to="/" className="text-xl font-bold">
              Academic<span className="text-accent">Portfolio</span>
            </Link>
            <p className="mt-2 text-white/80 text-sm">
              Academic research, teaching, and professional portfolio
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
            <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <a
                  href="mailto:academic@example.com"
                  className="text-white hover:text-accent transition-colors"
                  aria-label="Email"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li>
                  <Link to="/publications" className="hover:text-accent transition-colors">Publications</Link>
                </li>
                <li>
                  <Link to="/cv" className="hover:text-accent transition-colors">CV</Link>
                </li>
              </ul>
            </div>
          </div>
